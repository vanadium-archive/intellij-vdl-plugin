...
public class VdlParserDefinition implements ParserDefinition {
    ...
    public static final TokenSet KEYWORDS = TokenSet.create(
            PACKAGE, IMPORT, BREAK, CASE, CHAN, CONST, CONTINUE, DEFAULT, DEFER, ELSE, ENUM, ERROR, FALLTHROUGH, FOR, FUNC, GO, GOTO, IF, IMPORT,
            INTERFACE, MAP, PACKAGE, RANGE, RETURN, SELECT, SET, STREAM, STRUCT, SWITCH, TYPE_, VAR, UNION);
