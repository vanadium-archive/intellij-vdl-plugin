...
import io.v.vdl.psi.VdlStringLiteral;
import org.jetbrains.annotations.NotNull;

import java.util.Locale;

public class VdlStringLiteralEscaper extends LiteralTextEscaper<VdlStringLiteral> {

    private int[] outSourceOffsets;

    public VdlStringLiteralEscaper(@NotNull VdlStringLiteral host) {
        super(host);
    }
