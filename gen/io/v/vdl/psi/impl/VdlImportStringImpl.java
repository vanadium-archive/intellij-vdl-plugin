...
public class VdlImportStringImpl extends VdlCompositeElementImpl implements VdlImportString {

  public VdlImportStringImpl(ASTNode node) {
    super(node);
  }
  ...
  public PsiDirectory resolve() {
    return VdlPsiImplUtil.resolve(this);
  }
