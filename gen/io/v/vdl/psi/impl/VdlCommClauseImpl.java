...
public class VdlCommClauseImpl extends VdlCompositeElementImpl implements VdlCommClause {

  public VdlCommClauseImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public VdlCommCase getCommCase() {
    return findNotNullChildByClass(VdlCommCase.class);
  }
