...
public class VdlShortVarDeclarationImpl extends VdlVarSpecImpl implements VdlShortVarDeclaration {

  public VdlShortVarDeclarationImpl(ASTNode node) {
    super(node);
  }

  public VdlShortVarDeclarationImpl(VdlVarSpecStub stub, IStubElementType nodeType) {
    super(stub, nodeType);
  }
