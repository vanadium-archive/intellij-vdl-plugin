...
public class VdlBuiltinArgsImpl extends VdlCompositeElementImpl implements VdlBuiltinArgs {

  public VdlBuiltinArgsImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof VdlVisitor) ((VdlVisitor)visitor).visitBuiltinArgs(this);
